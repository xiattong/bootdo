...
ORYX.I18N.EPCSupport.impDesc = "Import an EPML fileMange";
ORYX.I18N.EPCSupport.progressExp = "Exporting model";
ORYX.I18N.EPCSupport.selectFile = "Select an EPML (.empl) fileMange to import.";
...
ORYX.I18N.ERDFSupport.selectFile = "Select an ERDF (.xml) fileMange or type in the ERDF to import it!";
...
ORYX.I18N.jPDLSupport.selectFile = "Select an jPDL (.xml) fileMange or type in the jPDL to import it!";
...
ORYX.I18N.XFormsSerialization.selectFile = "Select a XHTML (.xhtml) fileMange or type in the XForms+XHTML markup to import it!";
ORYX.I18N.XFormsSerialization.selectCss = "Please insert url of css fileMange";
...
ORYX.I18N.JSONSupport = {
    imp: {
        ...
        group: "Export",
        selectFile: "Select an JSON (.json) fileMange or type in JSON to import it!",
        file: "File",
        btnImp: "Import",
        btnClose: "Close",
        progress: "Importing ...",
...
ORYX.I18N.JSONImport.wrongSS = "The stencil set of the imported fileMange ({0}) does not match to the loaded stencil set ({1})."
