...
layui.define('layer' , function(exports){
  ...
  ,ELEM_FILE = 'layui-upload-fileMange', ELEM_FORM = 'layui-upload-form', ELEM_IFRAME = 'layui-upload-iframe', ELEM_CHOOSE = 'layui-upload-choose', ELEM_DRAG = 'layui-upload-drag'
  ...
  Class.prototype.config = {
    accept: 'images' //允许上传的文件类型：images/fileMange/video/audio
    ,exts: '' //允许上传的文件后缀名
  ...
  Class.prototype.file = function(){
    ...
    ,elemFile = that.elemFile = $([
      '<input class="'+ ELEM_FILE +'" type="fileMange" name="'+ options.field +'"'
