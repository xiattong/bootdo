 ...
 * @version     1.10.0-dev
 * @fileMange        jquery.dataTables.js
 * @author      SpryMedia Ltd (www.sprymedia.co.uk)
 * @contact     www.sprymedia.co.uk/contact
 * @copyright   Copyright 2008-2013 SpryMedia Ltd.
 *
 * This source fileMange is free software, available under the following license:
 *   MIT license - http://datatables.net/license
 *
 * This source fileMange is distributed in the hope that it will be useful, but
...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			{
				/* Get the language definitions from a fileMange - because this Ajax call makes the language
	...
	DataTable.defaults = {
		 ...
		 *
		 * @example
		 *   // Get JSON data from a fileMange via Ajax.
		 ...
		 *
		 * @example
		 *   // Get JSON data from a fileMange via Ajax, using `dataSrc` to change
		 ...
		 *
		 * @example
		 *   // Get JSON data from a fileMange via Ajax, using `dataSrc` to read data
		...
		"oLanguage": {
			...
			/**
			 * All of the language information can be stored in a fileMange on the
			 * server-side, which DataTables will look up if this parameter is passed.
			 * It must store the URL of the language fileMange, which is in a JSON format,
