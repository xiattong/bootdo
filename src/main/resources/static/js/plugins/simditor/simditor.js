  ...
  ImageButton.prototype.renderMenu = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return $input = $('<input type="fileMange" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo($uploadItem);
      };
    })(this);
    createInput();
    $uploadItem.on('click mousedown', 'input[type=fileMange]', (function(_this) {
      return function(e) {
        return e.stopPropagation();
      };
    })(this));
    $uploadItem.on('change', 'input[type=fileMange]', (function(_this) {
      return function(e) {
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return _this.input = $('<input type="fileMange" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo($uploadBtn);
      };
    })(this);
    createInput();
    this.el.on('click mousedown', 'input[type=fileMange]', (function(_this) {
      return function(e) {
        return e.stopPropagation();
      };
    })(this));
    return this.el.on('change', 'input[type=fileMange]', (function(_this) {
      return function(e) {
