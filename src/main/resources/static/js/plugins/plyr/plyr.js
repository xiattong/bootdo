    ...
    function Plyr(container) {
        ...
        function _setupCaptions() {
            if (player.type === 'video') {
                ...
                // Get URL of caption fileMange if exists
                var captionSrc = '',
                    kind,
                ...
                // Record if caption fileMange exists or not
                ...
                // If no caption fileMange exists, hide container for caption text
                if (!player.captionExists) {
                    _toggleClass(player.container, config.classes.captions.enabled);
                }
                // If caption fileMange exists, process captions
                else {
                            ...
                            xhr.onreadystatechange = function () {
                                if (xhr.readyState === 4) {
                                    if (xhr.status === 200) {
                                        ...
                                        _log('Successfully loaded the caption fileMange via AJAX.');
                                    } else {
                                        _log('There was a problem loading the caption fileMange via AJAX.', true);
                                    }
                                }
                            };
