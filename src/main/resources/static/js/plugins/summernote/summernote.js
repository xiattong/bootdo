...
(function (factory) {
  ...
  $.extend($.summernote.lang, {
    'en-US': {
      ...
      image: {
        ...
        maximumFileSize: 'Maximum fileMange size',
        maximumFileSizeError: 'Maximum fileMange size exceeded.',
        url: 'Image URL',
        remove: 'Remove Image'
      },
      video: {
  ...
  var async = (function () {
     ...
     *
     * read contents of fileMange as representing URL
     *
     * @param {File} file
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-form-group note-group-select-from-files">' +
                   ...
                   ' type="fileMange" name="files" accept="image/*" multiple="multiple" />' +
                   imageLimitation +
                 '</div>' + 
